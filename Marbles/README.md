...
the game starts by asking you to hide a certain amount of marbles of your choice as long as you have enough. for example if you chose 5 but you chose 6, the program asks you to choose a number less or equal to 5.

- the computer then guesses if the number you hid is even or odd. if the computer is right 
